...
| Category | Purpose |
|---|---|
| DJ'lik | Beginner-to-pro DJ guides — the SEO engine and DJ Academy funnel |
| Prodüksiyon | Music production guides |
| Sahne & Kültür | Local scene, venues, festivals, genre history — identity content |
| Röportaj | Artist/industry interviews — brand & sharing (not SEO-driven) |
