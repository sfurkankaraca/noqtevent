-- Kayseri soğuk başlangıç seed'i (kurucu onayı: 2026-08-02 'sen yapar mısın').
-- Kaynak: ops/kayseri-seed.sql (envanter: ops/kayseri-mekan-envanteri.md).
-- İdempotent (slug WHERE NOT EXISTS) — tekrar uygulanması güvenli.
-- Satırlar potential + is_published=false doğar; kurucu panelden onaylar/yayınlar.
