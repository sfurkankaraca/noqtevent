      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
        ...
        <div>
          ...
          <div className="mt-12 space-y-5">
            ...
            <a href="https://wa.me/905417997973" target="_blank" rel="noopener noreferrer" onClick={() => trackEvent("whatsapp_click", { location: "contact" })} className="flex items-center gap-4 group">
