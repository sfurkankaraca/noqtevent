...
export default async function Page({ searchParams }: Props) {
  ...
  let query = supabase
    .from("dj_profiles")
    .select("id, name, bio, photo_url, photos, focal_points, concept_tags, soundcloud_url, mixcloud_url, youtube_url, instagram_url, spotify_url, website_url, performer_type, city, speciality, preview_video_url")
    .eq("is_active", true)
