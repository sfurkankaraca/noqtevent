      ...
      <div className="bg-white rounded-2xl border border-border p-6">
        ...
        <div className="grid grid-cols-2 gap-4 text-sm">
          ...
          <div>
            ...
            <a href={`mailto:${inq.contact?.email}`} className="text-foreground mt-0.5 hover:underline">
              {inq.contact?.email}
            </a>
          </div>
          <div>
            <p className="text-xs text-muted-foreground">Telefon</p>
            <a href={`tel:${inq.contact?.phone}`} className="text-foreground mt-0.5 hover:underline">
              {inq.contact?.phone}
            </a>
          </div>
        </div>
